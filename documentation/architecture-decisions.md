...
- **Policy Origin Authority Rule:** The standalone `moiz-za/etsy-seller-seo-system` repository is designated as the **Policy Origin Authority**. Whenever Etsy marketplace rules or policy guidelines change (e.g. August 2026 Creativity Standards or algorithm updates), policy maintenance sweeps must update `etsy-seller-seo-system` first and re-sync `integration/etsy-seo-engine/` in ESVG-DIS.
